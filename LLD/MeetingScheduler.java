...
public class MeetingScheduler {
        ...
        public List<LocalDateTime> findAlternativeSlots(Set<User> attendees, Duration duration, 
            ...
            for (int day = 0; day <= daysAhead; day++) {
                ...
                for (int hour = 9; hour <= 17; hour++) {
                    ...
                    if (attendees.stream().allMatch(user -> 
                        user.isAvailable(slotTime, duration))) {
                        alternatives.add(slotTime);
                        if (alternatives.size() >= 5) break; // Return top 5 alternatives
                    }
                }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Average Response Time: " + scheduler.performanceMonitor.getAverageResponseTime() + "ms");
